...
function(t, e) {
    ...
    e.extend(!0, e.fancybox.defaults, {
        ...
        o && (t = o.current.opts.hash === !1 ? o.current.src : window.location, n = o.current.opts.share.tpl.replace(/\{\{src\}\}/g, encodeURIComponent(t)).replace(/\{\{src_raw\}\}/g, t).replace(/\{\{descr\}\}/g, o.$caption ? encodeURIComponent(o.$caption.text()) : ""), e.fancybox.open({
            src: o.translate(o, n),
            type: "html",
            opts: {
