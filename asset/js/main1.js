jQuery(document).ready(function($) {
    ...
    var x = $(window).width();
    if (x <= 2000) {
        $(".row_header5").attr("data-offset-top", "990");
    }
    if (x <= 1680) {
        $(".row_header5").attr("data-offset-top", "876");
    }
    if (x <= 1440) {
        $(".row_header5").attr("data-offset-top", "750");
    }
    if (x <= 1360) {
        $(".row_header5").attr("data-offset-top", "703");
    }
    if (x <= 1240) {
        $(".row_header5").attr("data-offset-top", "646");
    }
    if (x <= 1170) {
        $(".row_header5").attr("data-offset-top", "610");
    }
    if (x <= 1024) {
        $(".row_header5").attr("data-offset-top", "10");
    }
